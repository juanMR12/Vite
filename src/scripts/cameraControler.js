...
import {
  GUI
} from '/node_modules/three/examples/jsm/libs/lil-gui.module.min.js';
...
// Class that encapsulates the relevants methods needed to implement Camera First Person and Orbit Controlers
class cameraControler {

  constructor(_camera, _renderer, _controler_mode) {
    ...
    // Panel Menus Must Be Created on the App Side, else itll be buged if created in this class
  }

}

// Export the neccesary class/functions
export {
  cameraControler
};